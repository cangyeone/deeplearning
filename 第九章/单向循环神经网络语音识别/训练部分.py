...
class TextDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        lf = feq.shape[0] # 频谱有多少时间步
        ll = lab.shape[0] # 标签有多少字符
...
def main():
    ...
    if gpu:
        model.cuda() 
    model.load_state_dict(torch.load("ckpt/speech.oneway.stft.pt"))
    ...
    for b in range(n_epoch):
        ...
        torch.save(model.state_dict(), "ckpt/speech.oneway.stft.pt")
from scipy.io import wavfile
import scipy.signal as signal 
